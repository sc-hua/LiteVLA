...
# Written by Ze Liu, modified by Sicheng Hua
# --------------------------------------------------------'
...
_C.MODEL = CN()
# Model type
_C.MODEL.TYPE = 'litevla'
# Model name
_C.MODEL.NAME = 'litevla_t'
...
_C.MODEL.LITEVLA.DEPTHS = [2, 2, 11, 3]
_C.MODEL.LITEVLA.BLOCK_TYPES = ['GAB', 'GAB', 'VLA', 'VLA']
_C.MODEL.LITEVLA.STEM_KERNEL = 5
_C.MODEL.LITEVLA.DS_EXP = 4
_C.MODEL.LITEVLA.DS_KERNEL = 3
_C.MODEL.LITEVLA.DS_FUSE = "ff--"
_C.MODEL.LITEVLA.ACT = 'silu'
_C.MODEL.LITEVLA.DWC_KERNEL = 5
_C.MODEL.LITEVLA.AGG_RATIO = 0.5
_C.MODEL.LITEVLA.ATTN_RATIO = 1/8
_C.MODEL.LITEVLA.ATTN_KERNEL = 'elu1'
_C.MODEL.LITEVLA.ATTN_NORM = 'mrms'
_C.MODEL.LITEVLA.MLP_RATIO = 3
_C.MODEL.LITEVLA.HEAD_NORM = 'mrms'
# _C.TRAIN.USE_CHECKPOINT = False
_C.MODEL.LITEVLA.DISTILLATION = False
...
# add for mimic softmax attention
_C.TRAIN.MIMIC_WEIGHT = 1.0
_C.TRAIN.USE_MIMIC_SA = False
